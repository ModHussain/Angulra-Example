    ...
    $scope.$on('$viewContentLoaded', function () {
		...
		$scope.companyid = function(){
            ...
            debugger;
			 ...
			 $scope.companyId =  $scope.list._id;
...
$scope.saveDetails = function () {
	debugger;
	$scope.postrequirement.requirementId = $scope.companyId;
    ...
    RAService.updatepostareq($stateParams.postId,$scope.postrequirement).then(function(data){
	$scope.postdata = data;

	...
	return{
		...
		adddata: function(postrequirement){
			...
			mappingresource: function(filter){
				...
				var deferred = $q.defer();
				$http.get(APIURL + "/ResourceAdda/rest/resource/findResourcesByTwoIds/"+ filter.selecttype +'/'+ filter.nameId +'/'+ filter.localId +'/1/10').success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
			...
			getallusersByCompanyId: function(filter){

				var deferred = $q.defer();
				$http.get('http://localhost:8080/ResourceAdda/rest/user/findAllByRegistrationId/'+ filter +'/1/10').success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
			...
			Getfile: function(local){
				debugger;
				var deferred = $q.defer();
				$http.get(APIURL + '/ResourceAdda/rest/resource/downloadFile/'+local._id).success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
	...
	return{
		...
		adddata: function(postrequirement){
			...
			getallusersByCompanyId: function(filter){
				...
				var deferred = $q.defer();
				$http.get(APIURL+ '/ResourceAdda/rest/user/findAllByRegistrationId/'+ filter +'/1/10').success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
